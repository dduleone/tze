 ...
 *      Ack!Mud 4.0
 *	Zenithar
 *	rulers.c--handles setting up rulers for areas
...
char *get_ruler_title( int ruler_rank, int sex )
{
  ...
  {
    case 0 :  return "";
    case 1 :  return ( ( sex == SEX_NEUTRAL ) ? "@@WMonitor@@N " 
                       : ( sex == SEX_MALE ) ? "@@WLord@@N " 
                       : "@@WLady@@N " );
              break;
    case 2 :  return ( ( sex == SEX_NEUTRAL ) ? "@@eOverseer@@N " 
                       : ( sex == SEX_MALE ) ? "@@eBaron@@N " 
                       : "@@eBaroness@@N " );
              break;
    case 3 :  return ( ( sex == SEX_NEUTRAL ) ? "@@mController@@N " 
                       : ( sex == SEX_MALE ) ? "@@mDuke@@N " 
                       : "@@mDuchess@@N " );
              break;
    case 4 :  return ( ( sex == SEX_NEUTRAL ) ? "@@lDirector@@N " 
                       : ( sex == SEX_MALE ) ? "@@lPrince@@N " 
                       : "@@lPrincess@@N " );
              break;
    case 5 :  return ( ( sex == SEX_NEUTRAL ) ? "@@aDominator@@N " 
...
/*  CONTROL_DATA	* this_control;  */
  ...
  if ( !str_prefix( arg1, "delete" ) )
  {
    ...
    free_string( ruler->this_one->name );
    free_string( ruler->this_one->affiliation_name );
    free_string( ruler->this_one->keywords );
    if ( ruler->this_one->first_control != NULL )
    {
      CONTROL_LIST	* control;

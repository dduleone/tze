...
*/
     if ( victim->position > POS_SLEEPING ) 
   {
...

     {
       ...
       send_to_char( "a hot, coppery tasting fluid enter your mouth.  As the strength of the @@dKindred@@N begins to fill\n\r", victim );
